...
export const MiddleBarHeader = ({ room, setShowRightBar }) => {
  ...
  return (
    <Box p='2' backgroundColor='#f8f8f8' width='100%' height='8%'>
         <Flex alignItems='center' mb='2'>
            <Flex gap='2' cursor='pointer' onClick={() => setShowRightBar('details')}>
            ...
            <Flex alignItems='center' gap='2' mb='2'>
                <IconButton icon={<AiOutlineSearch/>} variant='unstyled' size='sm' onClick={() => setShowRightBar('search')}/>
